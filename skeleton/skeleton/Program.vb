...
Module Module1
                ...
                If Deck.GetCardDescriptionAt(0) = "Dif" Then
                    ...
                    While validChoice = False
                        ...
                        ElseIf Choice >= 1 And Choice <= 5 Then
                            validChoice = True
                        Else
                            Console.WriteLine("Please enter a valid integer OR valid string.")
                        End If
                    End While
                    Console.WriteLine()
    ...
    Class DifficultyCard 'Class name
        Inherits Card
    ...
    Class CardCollection 'Class name
